...
def new():
    ...
    with open("text.json", "w") as msnmsnger:
        ...
        msnmsnger.close()
    with open("sound.json", "w") as snoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooop:
        json.dump(sound, snoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooop, indent=4)
        snoooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooop.close()
