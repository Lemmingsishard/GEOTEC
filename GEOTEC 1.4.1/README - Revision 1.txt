...
------------------------------------------------------------------------------
Part 3. Editor Controls

When you open the Launcher, if you have no saves, make a new save then press play. Once you are in the engine itself, most of the buttons are obvious except the one in the bottom right-hand corner which is to mute the sound. Press Esc to return to this menu. Pressing Ctrl + w + g does something special.

When you press play on the current screen, if the edit mode is on, you are greeted with non-descript colorful buttons. 

The Red button turns on delete mode which is used when needing to remove a tile. delete mode turns off automatically after you delete a tile.

The Purple button changes which set of tile you use.

The Pink button saves the map you are working on.

The Blue button turns on/off the grid.

The Green tile allows you to place a tile.

The Orange button changes which tile you are using in the set.
...
I hope you enjoy this strange thing, and do many great things with it, have a wonderful day
	...
	- Lemmingsishard of UPGSOFTWARE, part of WIZARDSTUDIOS - 30.6.24
